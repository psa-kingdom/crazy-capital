...
const DEFAULT_DEMO_NOTIFICATIONS: NotificationItem[] = [
  ...
  },
  {
    ...
    status: 'SENT',
    metadata: { isRead: true, readAt: new Date().toISOString(), actionUrl: '/admin/mandates' },
  ...
  },
  {
    ...
    status: 'DELIVERED',
    metadata: { isRead: true, readAt: new Date().toISOString(), priority: 'URGENT', actionUrl: '/admin/sla' },
