...
const DEFAULT_DEMO_NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    status: 'DELIVERED',
    metadata: { isRead: false, priority: 'URGENT', actionUrl: '/admin/leads' },
  ...
  },
  {
    ...
    status: 'SENT',
    metadata: { isRead: false, priority: 'HIGH', actionUrl: '/admin/documents' },
  ...
  },
  {
    ...
    status: 'SENT',
    metadata: { isRead: true, readAt: '2026-08-29T09:45:00.000Z', actionUrl: '/admin/mandates' },
  ...
  },
  {
    ...
    status: 'DELIVERED',
    metadata: { isRead: true, readAt: '2026-08-28T11:45:00.000Z', priority: 'URGENT', actionUrl: '/admin/sla' },
...
export function NotificationCentre({ className = '' }: { className?: string }) {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      if (!hasToken) {
        // Unauthenticated visitor: compute from local state without network polling
